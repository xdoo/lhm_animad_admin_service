package de.muenchen.animad.admin.administration.service.gen.controller.businessactions;
...
import de.muenchen.animad.admin.administration.service.gen.businessActionParams.CreateAppointment_BusinessActionParameters;
...
public class BusinessActionController implements ResourceProcessor<RepositoryLinksResource> {
	...
	@Autowired
	CreateAppointment_BusinessActionService createAppointmentactionService;
	@Autowired
    ...
    public List<Link> getMethodActions() {
		...
		methodLinks.add(new Link(base + "/createAppointment", "createAppointment"));
	...
	public ResponseEntity<?> createAppointment(PersistentEntityResourceAssembler assembler, @RequestHeader Map<String, Object> headers, @RequestBody CreateAppointment_BusinessActionParameters body)
	{	
		java.time.LocalDateTime result = createAppointmentactionService.createAppointment(headers, body.getSpecies(), body.getAnimalName(), body.getReasonForAppointment());
